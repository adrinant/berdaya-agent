...
def _routermint_headers() -> dict:
    ...
    return {
        "User-Agent": f"Berdaya AgentAgent/{_HERMES_VERSION}",
    }
...
class AIAgent:
    ...
    def _ensure_lmstudio_runtime_loaded(self, config_context_length: Optional[int] = None) -> None:
        """
        Preload the LM Studio model with at least Berdaya Agent' minimum context.
        """
    ...
    def _decorate_xai_entitlement_error(detail: str) -> str:
        ...
        SuperGrok subscribers can use Berdaya Agent against xai-oauth.  Lots of
