#!/usr/bin/env python3
"""
SWE Runner with Berdaya Agent Trajectory Format

A runner that uses Berdaya-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Berdaya-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Berdaya-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Berdaya Agent format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Berdaya-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Berdaya-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Berdaya Agent Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Berdaya-Agent's built-in execution environments
    and outputs trajectories in Berdaya-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to Berdaya Agent trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Berdaya Agent trajectory format
...
def main(
    ...
    """
    Run SWE tasks with Berdaya Agent trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Berdaya Agent Trajectory Format")
    print("=" * 60)
