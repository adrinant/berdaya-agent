  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Berdaya Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Berdaya Agent &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Berdaya Agent?{' '}
        <a
