#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Berdaya Agent docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Berdaya Agent as a Python Library", None),
        ("guides/use-mcp-with-hermes", "Use MCP with Berdaya Agent", None),
        ("guides/use-voice-mode-with-hermes", "Use Voice Mode with Berdaya Agent", None),
        ("guides/use-soul-with-hermes", "Use SOUL.md with Berdaya Agent", None),
        ("guides/build-a-hermes-plugin", "Build a Berdaya Agent Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Berdaya Agent"),
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Berdaya Agent — Full Documentation\n",
        (
            "This file is the entire Berdaya Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Berdaya Agent, Features, Messaging, Integrations, Guides, "
