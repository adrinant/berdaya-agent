...
description: "Reference for Berdaya Agent core, composite, platform, and dynamic toolsets"
---
...
| `code_execution` | `execute_code` | Run Python scripts that call Berdaya Agent tools programmatically. |
