---
sidebar_position: 8
title: "Use Voice Mode with Berdaya Agent"
description: "A practical guide to setting up and using Berdaya Agent voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Berdaya Agent
...
- you want Berdaya Agent sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Berdaya Agent.
...
## Step 1: make sure normal Berdaya Agent works first

Before touching voice mode, verify that:
- Berdaya Agent starts
...
Berdaya Agent supports both local and cloud speech stacks.
...
4. Berdaya Agent transcribes and responds
...
- asking Berdaya Agent to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Berdaya Agent loop.

## Tuning CLI behavior

### Silence threshold

If Berdaya Agent starts/stops too aggressively, tune:
...
Berdaya Agent stays a normal chat bot, but can speak replies.
...
- you want Berdaya Agent to function like a portable research or ops assistant
...
Berdaya Agent joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Berdaya Agent detects speech boundaries
- transcripts are posted in the associated text channel
- Berdaya Agent responds in text and audio
...
1. get text Berdaya Agent working
