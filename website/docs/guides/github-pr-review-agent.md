...
┌───────────────────────────────────────────────────────────────────┐
│                                                                   │
│   Cron Timer  ──▶  Berdaya Agent  ──▶  GitHub API  ──▶  Review     │
...
If you have a public endpoint available, check out [Automated GitHub PR Comments with Webhooks](./webhook-github-pr-review.md) — GitHub pushes events to Berdaya Agent instantly when PRs are opened or updated.
:::
...
- **Berdaya Agent installed** — see the [Installation guide](/getting-started/installation)
...
Make sure Berdaya Agent can access GitHub. Start a chat:
...
Still in the chat, ask Berdaya Agent to review a real PR:
...
A skill gives Berdaya Agent consistent review guidelines that persist across sessions and cron runs. Without one, review quality varies.
...
This is what makes the reviewer actually useful. Start a session and teach Berdaya Agent your team's standards:
...
2. Teach Berdaya Agent your conventions via memory (Step 4)
