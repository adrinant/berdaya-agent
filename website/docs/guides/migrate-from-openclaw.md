...
description: "Complete guide to migrating your OpenClaw / Clawdbot setup to Berdaya Agent — what gets migrated, how config maps, and what to check after."
---

# Migrate from OpenClaw

`hermes claw migrate` imports your OpenClaw (or legacy Clawdbot/Moldbot) setup into Berdaya Agent. This guide covers exactly what gets migrated, the config key mappings, and what to verify after migration.
...
| What | OpenClaw source | Berdaya Agent destination | Notes |
|------|----------------|-------------------|-------|
...
| Source | OpenClaw location | Berdaya Agent destination |
|--------|------------------|-------------------|
...
Skill conflicts are handled by `--skill-conflict`: `skip` leaves the existing Berdaya Agent skill, `overwrite` replaces it, `rename` creates a `-imported` copy.

### Model and provider configuration

| What | OpenClaw config path | Berdaya Agent destination | Notes |
|------|---------------------|-------------------|-------|
...
| What | OpenClaw config path | Berdaya Agent config path | Mapping |
|------|---------------------|-------------------|---------|
...
| OpenClaw config path | Berdaya Agent config path | Notes |
|---------------------|-------------------|-------|
...
| OpenClaw field | Berdaya Agent field | Notes |
|----------------|-------------|-------|
...
| What | Berdaya Agent destination |
|------|-------------------|
...
| Platform | OpenClaw config path | Berdaya Agent `.env` variable | Notes |
|----------|---------------------|----------------------|-------|
...
| What | OpenClaw path | Berdaya Agent path | Notes |
|------|-------------|-------------|-------|
...
### Archived (no direct Berdaya Agent equivalent)

These are saved to `~/.hermes/migration/openclaw/<timestamp>/archive/` for manual review:

| What | Archive file | How to recreate in Berdaya Agent |
|------|-------------|--------------------------|
| `IDENTITY.md` | `archive/workspace/IDENTITY.md` | Merge into `SOUL.md` |
| `TOOLS.md` | `archive/workspace/TOOLS.md` | Berdaya Agent has built-in tool instructions |
...
| Multi-agent list | `archive/agents-list.json` | Use Berdaya Agent profiles |
