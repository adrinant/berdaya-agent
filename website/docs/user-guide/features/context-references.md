...
Type `@` followed by a reference to inject content directly into your message. Berdaya Agent expands the reference inline and appends the content under an `--- Attached Context ---` section.
...
- Berdaya Agent env: `$HERMES_HOME/.env`
