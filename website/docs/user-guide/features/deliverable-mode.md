...
When Berdaya Agent runs inside a messaging gateway (Slack, Discord, Telegram,
...
If you use Berdaya Agent' kanban multi-agent workflow, workers can attach
...
back into the thread as a native attachment. Berdaya Agent's deliverable
