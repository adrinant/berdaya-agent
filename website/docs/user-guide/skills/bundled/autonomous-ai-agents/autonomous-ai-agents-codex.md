...
Delegate coding tasks to [Codex](https://github.com/openai/codex) via the Berdaya Agent terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Berdaya Agent itself, `model.provider: openai-codex` uses Berdaya-managed Codex
...
## Berdaya Agent Gateway Caveat

When invoking the Codex CLI from a Berdaya Agent gateway/service context (for example,
