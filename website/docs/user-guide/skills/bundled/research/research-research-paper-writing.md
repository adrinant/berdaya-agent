...
## Berdaya Agent Integration

This skill is designed for the Berdaya Agent agent. It uses Berdaya Agent tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Berdaya Agent skills for specific phases:
