...
| Version | `0.1.0` |
| Author | Bihruze (Asahi0x), Berdaya Agent |
| License | MIT |
...
import upstream classes into Berdaya Agent itself.
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside Berdaya Agent core.
