...
- User wants **Berdaya Agent itself to drive a browser** → use Berdaya Agent' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
