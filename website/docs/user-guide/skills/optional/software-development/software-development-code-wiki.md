...
| Version | `0.1.0` |
| Author | Teknium (teknium1), Berdaya Agent |
| License | MIT |
...
1. **User input** — [`cli.py:Berdaya AgentCLI.run_session`](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/software-development/code-wiki/<link>)
