...
| Version | `1.0.0` |
| Author | arceus77-7, enhanced by Berdaya Agent |
| License | MIT |
...
- `tmux` available for stable authenticated sessions during Berdaya Agent terminal calls (desktop app flow only)
...
### Service Account (recommended for Berdaya Agent)
...
## Berdaya Agent Execution Pattern (desktop app flow)

Berdaya Agent terminal commands are non-interactive by default and can lose auth context between calls.
