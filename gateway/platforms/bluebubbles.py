...
# group mention gating without custom aliases, use conservative Berdaya Agent wake
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        JSON list, or comma/newline-separated), or None (use Berdaya Agent defaults).
        """
        if raw is None:
