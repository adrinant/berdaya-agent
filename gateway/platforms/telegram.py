...
class TelegramAdapter(BasePlatformAdapter):
    ...
    def _thread_kwargs_for_send(
        ...
        metadata. Berdaya-created private-chat topic lanes are marked with
    ...
    async def _handle_polling_conflict(self, error: Exception) -> None:
        ...
        message = (
            ...
            "To recover: ensure no other Berdaya Agent or OpenClaw instance is running "
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # readable by the Berdaya Agent process (shared mount, same machine, etc.).
    ...
    def _explicit_bot_mentions_exclude_self(self, message: Message) -> bool:
        ...
        Telegram groups can contain several Berdaya Agent bot profiles. A message like
