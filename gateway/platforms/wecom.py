    ...
    async def _download_remote_bytes(
        ...
        try:
            async with client.stream(
                ...
                url,
                headers={
                    "User-Agent": "Berdaya AgentAgent/1.0",
                    "Accept": "*/*",
                },
            ) as response:
...
def qr_scan_for_bot_info(
    *,
    ...
    try:
        req = urllib.request.Request(generate_url, headers={"User-Agent": "Berdaya AgentAgent/1.0"})
    ...
    while time.monotonic() < deadline:
        try:
            req = urllib.request.Request(query_url, headers={"User-Agent": "Berdaya AgentAgent/1.0"})
