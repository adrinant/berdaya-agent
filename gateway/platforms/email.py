"""
Email platform adapter for the Berdaya Agent gateway.

Allows users to interact with Berdaya Agent by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Berdaya Agent")
