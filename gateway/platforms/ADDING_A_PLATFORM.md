...
There are two ways to add a platform to the Berdaya Agent gateway:
...
**zero changes to core Berdaya Agent code**.
...
Checklist for integrating a platform directly into the Berdaya Agent core.
