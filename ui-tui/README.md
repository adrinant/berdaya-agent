...
React + Ink terminal UI for Berdaya Agent. TypeScript owns the screen. Python owns sessions, tools, model calls, and most command logic.
...
tui_gateway/
  ...
  slash_worker.py        persistent Berdaya AgentCLI subprocess for slash commands
```
