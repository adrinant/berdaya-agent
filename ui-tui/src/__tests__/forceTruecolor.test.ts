...
describe('forceTruecolor', () => {
  ...
  it('respects existing FORCE_COLOR unless Berdaya Agent truecolor is explicit', async () => {
    await withCleanEnv(
      () => {
  ...
  it('lets explicit Berdaya Agent truecolor override existing FORCE_COLOR', async () => {
    await withCleanEnv(
      () => {
