"""ntfy platform adapter (Berdaya Agent plugin).
...
a Berdaya Agent dependency.

This adapter ships as a Berdaya Agent platform plugin under
``plugins/platforms/ntfy/``. The Berdaya Agent plugin loader scans the
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        install_hint="pip install httpx   # already a Berdaya Agent dependency",
