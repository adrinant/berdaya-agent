...
Credential storage mirrors every other Berdaya Agent channel:
...
# registers Berdaya Agent as its own client_id.
...
# Default name of the project Berdaya Agent provisions for the operator.
DEFAULT_PROJECT_NAME = "Berdaya Agent"
...
def _auth_json_path() -> Path:
    """Resolve ``~/.hermes/auth.json`` honouring the active Berdaya Agent profile."""
    try:
