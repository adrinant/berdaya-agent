"""
Microsoft Teams platform adapter for Berdaya Agent.
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            self._app = App(
                ...
                client=ClientOptions(headers={"User-Agent": "Berdaya Agent"}),
            )
...
def interactive_setup() -> None:
    ...
    print_info("  teams app create --name \"Berdaya Agent\" --endpoint \"https://<tunnel>/api/messages\"")
    print()
