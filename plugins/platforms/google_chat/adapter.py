...
#     fresh "Berdaya Agent is thinking…" card during the small window between
...
class GoogleChatAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        # they don't sit in the chat forever as "Berdaya Agent is thinking…".
    ...
    async def send_typing(self, chat_id: str, metadata: Any = None) -> None:
        """Post a visible 'Berdaya Agent is thinking…' marker message.
        ...
        "Berdaya Agent is thinking…" stuck in chat forever, plus one card that
        ...
        body: Dict[str, Any] = {"text": "Berdaya Agent is thinking…"}
        if thread_id:
            body["thread"] = {"name": thread_id}
    ...
    async def stop_typing(self, chat_id: str) -> None:
        ...
        Google Chat has no separate typing API: the "Berdaya Agent is thinking…"
    ...
    async def on_processing_complete(
        ...
        see "Berdaya Agent is thinking…" stuck forever.
        """
    ...
    async def _consume_typing_card_with_text(
        ...
        creating a fresh "Berdaya Agent is thinking…" card during any subsequent
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # the "Berdaya Agent is thinking..." marker patches and edit overhead.
        ...
        platform_hint=(
            ...
            "are generating a response, a 'Berdaya Agent is thinking…' marker message "
