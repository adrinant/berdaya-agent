...
required — uses aiohttp which is already a Berdaya Agent dependency.
...
def interactive_setup() -> None:
    ...
    print()
    print_info("📬 Home Channel: where Berdaya Agent delivers cron job results and notifications.")
