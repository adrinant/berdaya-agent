...
const isOpen = (gateway: Berdaya AgentGateway | null): boolean => gateway?.connectionState === 'open'
...
export const $gateway = atom<Berdaya AgentGateway | null>(null)
...
let primaryGateway: Berdaya AgentGateway | null = null
let primaryProfile = 'default'

export function setPrimaryGateway(gateway: Berdaya AgentGateway | null, profile = 'default'): void {
...
export function activeGateway(): Berdaya AgentGateway | null {
...
export async function ensureActiveGatewayOpen(): Promise<Berdaya AgentGateway | null> {
  if (activeKey === primaryProfile) {
    return primaryGateway
  }
