...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Berdaya Agent look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Berdaya Agent need to see?`,
    ...
    {
      headline: `What should ${label} Berdaya Agent tackle?`,
