 ...
 * product name (`Berdaya Agent`). If a PREVIOUS `npm run pack` was interrupted
 ...
 *   '.../release/linux-unpacked/electron' -> '.../release/linux-unpacked/Berdaya Agent'
 *
 ...
 * (the mac-unpacked Berdaya Agent.app bundle) and Windows (win-unpacked), so we
