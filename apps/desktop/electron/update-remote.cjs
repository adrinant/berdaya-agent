 ...
 *
 * A public install can end up with `origin=git@github.com:adrinant/berdaya-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/adrinant/berdaya-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/adrinant/berdaya-agent'
