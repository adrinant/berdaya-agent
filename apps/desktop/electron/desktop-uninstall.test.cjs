...
test('resolveRemovableAppPath finds the .app bundle on macOS', () => {
  assert.equal(
    resolveRemovableAppPath('/Applications/Berdaya Agent.app/Contents/MacOS/Berdaya Agent', 'darwin'),
    '/Applications/Berdaya Agent.app'
  )
  assert.equal(
    resolveRemovableAppPath('/Users/x/Applications/Berdaya Agent.app/Contents/MacOS/Berdaya Agent', 'darwin'),
    '/Users/x/Applications/Berdaya Agent.app'
  )
})
...
test('resolveRemovableAppPath finds the install dir on Windows', () => {
  assert.equal(
    resolveRemovableAppPath('C:\\Users\\x\\AppData\\Local\\Programs\\Berdaya Agent\\Berdaya Agent.exe', 'win32'),
    'C:\\Users\\x\\AppData\\Local\\Programs\\Berdaya Agent'
  )
  assert.equal(
    resolveRemovableAppPath('C:\\Users\\x\\AppData\\Local\\hermes-desktop\\Berdaya Agent.exe', 'win32'),
    'C:\\Users\\x\\AppData\\Local\\hermes-desktop'
  )
})

test('resolveRemovableAppPath returns null for an unrecognized Windows dir', () => {
  assert.equal(resolveRemovableAppPath('C:\\Temp\\foo\\Berdaya Agent.exe', 'win32'), null)
})

test('resolveRemovableAppPath uses APPIMAGE on Linux when set', () => {
  assert.equal(
    resolveRemovableAppPath('/tmp/.mount_Berdaya AgentXXXX/hermes', 'linux', { APPIMAGE: '/home/x/Apps/Berdaya Agent.AppImage' }),
    '/home/x/Apps/Berdaya Agent.AppImage'
  )
})
...
test('shouldRemoveAppBundle requires packaged AND a resolved path', () => {
  assert.equal(shouldRemoveAppBundle(true, '/Applications/Berdaya Agent.app'), true)
  assert.equal(shouldRemoveAppBundle(false, '/Applications/Berdaya Agent.app'), false)
...
test('buildWindowsCleanupScript waits (bounded) for PID, runs uninstall, rmdir bundle', () => {
  const script = buildWindowsCleanupScript({
    ...
    agentRoot: 'C:\\hermes',
    uninstallArgs: ['-m', 'hermes_cli.uninstall', '--mode', 'full'],
    appPath: 'C:\\Users\\x\\AppData\\Local\\Programs\\Berdaya Agent',
  ...
  assert.match(script, /rmdir \/s \/q "C:\\Users\\x\\AppData\\Local\\Programs\\Berdaya Agent" >nul 2>&1/)
