#!/usr/bin/env python3
"""
Hyperliquid CLI Tool for Berdaya Agent
-------------------------------------
...
USER_AGENT = "Berdaya AgentAgent/1.0"
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Hyperliquid CLI Tool for Berdaya Agent")
