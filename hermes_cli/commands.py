"""Slash command definitions and autocomplete for the Berdaya Agent CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Berdaya Agent config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal Berdaya Agent works on across turns until achieved", "Session",
    ...
    CommandDef("busy", "Control what Enter does while Berdaya Agent is working", "Configuration",
    ...
    CommandDef("update", "Update Berdaya Agent to the latest version", "Info"),
    CommandDef("version", "Show Berdaya Agent version", "Info", aliases=("v",)),
...
Telegram only displays a small BotCommand menu in practice.  The full Berdaya Agent
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to Berdaya Agent or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
