...
def _install_plugin_debug_handler(force: bool = False) -> None:
    ...
    is passed. Does not touch the root logger or other Berdaya Agent loggers.
    """
...
class PluginManager:
    ...
    def discover_and_load(self, force: bool = False) -> None:
        ...
        for manifest in winners.values():
            ...
            # for the same reason: every platform Berdaya Agent ships must be
