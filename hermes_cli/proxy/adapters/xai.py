...
# xAI's public API is OpenAI-compatible for the endpoints Berdaya Agent commonly
# uses. The Responses endpoint is included because Berdaya Agent' native xAI runtime
...
class XAIGrokAdapter(UpstreamAdapter):
    """Proxy upstream for xAI Grok via Berdaya-managed OAuth credentials."""
