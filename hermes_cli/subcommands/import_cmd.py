...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a Berdaya Agent backup from a zip file",
        description="Extract a previously created Berdaya Agent backup into your "
        "Berdaya Agent home directory, restoring configuration, skills, "
        "sessions, and data",
    )
