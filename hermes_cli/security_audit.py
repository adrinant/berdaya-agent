"""On-demand supply-chain audit for Berdaya Agent installs.

Scans three surfaces a Berdaya Agent user actually controls and we can map to
upstream advisories without auth or extra binaries:

1. The Berdaya Agent venv (every PyPI dist via ``importlib.metadata``).
