...
TIPS = [
    ...
    "Ctrl+Z suspends Berdaya Agent to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs Berdaya Agent itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Berdaya Agent home directory.",
    ...
    "hermes gateway install sets up Berdaya Agent as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Berdaya Agent tools programmatically — results stay out of context.",
    ...
    "When exiting, Berdaya Agent prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Berdaya Agent runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Berdaya Agent via a local macOS server.",
    ...
    "Berdaya Agent loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Berdaya Agent as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Berdaya Agent your own.",
    ...
    "Before a gateway session reset, Berdaya Agent auto-flushes important facts to memory in the background.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Berdaya Agent auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Berdaya Agent config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Berdaya Agent is working.',
    ...
    'hermes dashboard embeds the full Berdaya Agent TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Berdaya Agent block commands when the tirith scanner itself errors out.',
