"""
Security advisory checker for Berdaya Agent.
...
run in environments where the rest of Berdaya Agent failed to import.
"""
...
def _installed_version(pkg_name: str) -> Optional[str]:
    ...
    except ImportError:  # py<3.8 — Berdaya Agent requires 3.10+ but defensive.
        return None
    try:
