...
Pure logic: walks a Berdaya Agent config dict, returns issues for any reference
...
class RetirementIssue:
    """A reference to a retired xAI model found in a Berdaya Agent config."""
...
def find_retired_xai_refs(config: Dict[str, Any]) -> List[RetirementIssue]:
    """Walk all model slots in a Berdaya Agent config and return retirement issues.
