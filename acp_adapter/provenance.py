...
This is an additive Berdaya Agent extension surfaced under ACP ``_meta.hermes`` so
...
compression rotates the internal Berdaya Agent head, ``build_session_provenance`` lets
...
def build_session_provenance(
    ...
    *,
    ...
    Args:
        ...
        current_hermes_session_id: The live internal Berdaya Agent DB session id
    ...
    provenance: Dict[str, Any] = {
        ...
        "currentBerdaya AgentSessionId": current_hermes_session_id,
        "rootBerdaya AgentSessionId": root_id,
        "parentBerdaya AgentSessionId": parent_id,
        "sessionKind": "continuation" if is_continuation else "root",
        "compressionDepth": compression_depth,
    }
    if previous_hermes_session_id:
        provenance["previousBerdaya AgentSessionId"] = previous_hermes_session_id
    if rotated:
