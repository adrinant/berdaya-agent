...
if [ "$needs_chown" = true ]; then
    ...
    # Berdaya-owned subdirs: recursive chown is safe here because these are
...
# Berdaya-owned trees under $INSTALL_DIR must be re-chowned whenever the
...
# directory. agent-browser (the runtime CLI Berdaya Agent spawns for the
