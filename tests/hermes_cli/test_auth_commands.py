...
def test_auth_add_nous_oauth_persists_pool_entry(tmp_path, monkeypatch):
    ...
    # raises "Berdaya Agent is not logged into Nous Portal" and the agent dies.
...
# =============================================================================
# Unified credential-source stickiness — every source Berdaya Agent reads from has a
