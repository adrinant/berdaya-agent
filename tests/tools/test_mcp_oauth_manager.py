...
def test_hermes_provider_subclass_exists():
    """Berdaya AgentMCPOAuthProvider is defined and subclasses OAuthClientProvider."""
...
def test_manager_builds_hermes_provider_subclass(tmp_path, monkeypatch):
    """get_or_build_provider returns Berdaya AgentMCPOAuthProvider, not plain OAuthClientProvider."""
