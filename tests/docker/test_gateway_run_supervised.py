...
def test_supervised_gateway_stdout_reaches_docker_logs(
    ...
    a poor user experience: the iconic "Berdaya Agent Gateway Starting…"
    ...
    assert "⚕" in combined or "Berdaya Agent Gateway Starting" in combined, (
    ...
    assert "⚕" in file_contents or "Berdaya Agent Gateway Starting" in file_contents, (
