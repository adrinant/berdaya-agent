...
Under a gateway (Telegram, Discord, Slack, ...) Berdaya Agent passes the
...
class TestCrossPlatformMemoryUnification:
    """The same physical user talking to Berdaya Agent via Telegram AND Discord
...
class TestProfilePeerUniqueness:
    """Each Berdaya Agent profile can pin to its own unique peerName.
