...
{ inputs, ... }: {
  ...
  let
    ...
    deepConfigType = lib.types.mkOptionType {
      ...
      description = "Berdaya Agent YAML config (attrset), merged deeply via lib.recursiveUpdate.";
  ...
  in {
    options.services.hermes-agent = with lib; {
      enable = mkEnableOption "Berdaya Agent gateway service";
      ...
      settings = mkOption {
        ...
        default = { };
        description = ''
          Declarative Berdaya Agent config (attrset). Deep-merged across module
      ...
      environmentFiles = mkOption {
        ...
        description = ''
          ...
          Berdaya Agent reads this file on every startup via load_hermes_dotenv().
        '';
      };
      ...
      extraPlugins = mkOption {
        ...
        description = ''
          ...
          at its root. Berdaya Agent discovers these automatically on startup.
        '';
        example = literalExpression ''
          [
    ...
    HERMES_CONTAINER_MODE_EOF
          ...
          # Berdaya Agent reads $HERMES_HOME/.env at startup via load_hermes_dotenv(),
    ...
    HERMES_NIX_ENV_EOF
      ...
      (lib.mkIf cfg.container.enable {
        ...
        systemd.services.hermes-agent = {
          description = "Berdaya Agent Gateway (container)";
          wantedBy = [ "multi-user.target" ];
          after = [ "network-online.target" ]
