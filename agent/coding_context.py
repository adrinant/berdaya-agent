"""Coding-context awareness — base Berdaya Agent, every interactive surface.

When the user runs Berdaya Agent inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Berdaya Agent shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Berdaya Agent should operate in its coding posture right now."""
