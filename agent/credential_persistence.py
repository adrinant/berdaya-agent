...
# Sources Berdaya Agent owns and can intentionally persist in auth.json.  Everything
...
def sanitize_borrowed_credential_payload(
    ...
    Owned sources (manual entries and Berdaya-owned OAuth/device-code state)
