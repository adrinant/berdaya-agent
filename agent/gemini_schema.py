...
# outside that subset before sending Berdaya Agent tool schemas to Google.
...
def sanitize_gemini_schema(schema: Any) -> Dict[str, Any]:
    ...
    Berdaya Agent tool schemas are OpenAI-flavored JSON Schema and may contain keys
