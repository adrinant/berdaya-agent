...
projection into Berdaya Agent' display, approval bridging, transcript projection into
...
"codex_app_server"`. Berdaya Agent' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def initialize(
        ...
        client_title: str = "Berdaya Agent",
