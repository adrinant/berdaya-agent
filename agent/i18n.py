"""Lightweight internationalization (i18n) for Berdaya Agent static user-facing messages.

Scope (thin slice, by design): only the highest-impact static strings shown
to the user by Berdaya Agent itself -- approval prompts, a handful of gateway slash
