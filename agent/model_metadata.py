...
def _resolve_requests_verify() -> bool | str:
    ...
    by default. Berdaya Agent also honours HERMES_CA_BUNDLE (its own convention)
...
# Minimum context length required to run Berdaya Agent.  Models with fewer
...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # so these hardcoded fallbacks prevent Berdaya Agent from probing-down to
...
_URL_TO_PROVIDER: Dict[str, str] = {
    ...
    # (often 8K) makes it unusable for Berdaya Agent' system prompt, but mapping
        ...
        with httpx.Client(timeout=3.0, headers=headers) as client:
            ...
            if server_type == "ollama":
                ...
                if resp.status_code == 200:
                    ...
                    # Berdaya Agent grow conversations past the runtime limit and Ollama
...
def estimate_request_tokens_rough(
    ...
    *,
    ...
    Includes the major payload buckets Berdaya Agent sends to providers:
