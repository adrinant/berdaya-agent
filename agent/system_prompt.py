...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  Berdaya Agent never re-renders parts of this string mid-
    ...
    # Pointer to the hermes-agent skill + docs for user questions about Berdaya Agent itself.
    ...
    # Coding posture (base Berdaya Agent, any interactive coding surface in a code
    ...
    # Active-profile hint — names the Berdaya Agent profile the agent is running
    ...
    if active_profile == "default":
        stable_parts.append(
            "Active Berdaya Agent profile: default. Other profiles (if any) live "
        ...
        stable_parts.append(
            f"Active Berdaya Agent profile: {active_profile}. This session reads "
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — Berdaya Agent never rebuilds or reinjects parts of it
