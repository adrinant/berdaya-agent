...
# ---------------------------------------------------------------------------
# Provider ID mapping: Berdaya Agent ↔ models.dev
# ---------------------------------------------------------------------------

# Berdaya Agent provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → Berdaya Agent (built lazily)
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a Berdaya Agent provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal Berdaya Agent agent traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a Berdaya Agent provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve Berdaya Agent ID → models.dev ID
...
def get_model_info(
    ...
    Accepts Berdaya Agent or models.dev provider ID.  Tries exact match then
