# Berdaya Agent — Web UI

Browser-based dashboard for managing Berdaya Agent configuration, API keys, and monitoring active sessions.
...
| Wordmark | `Typography` + size/tracking only | Sidebar/mobile “Berdaya Agent” — mixed case, no Mondwest, no `text-display` |
