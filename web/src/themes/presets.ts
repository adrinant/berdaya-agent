...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Berdaya Agent Teal",
  description: "Classic dark teal — the canonical Berdaya Agent look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Berdaya Agent look, ported from the
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Berdaya Agent Teal (Large)",
  description: "Berdaya Agent Teal with bigger fonts and roomier spacing",
