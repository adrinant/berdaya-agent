/**
 * Berdaya Agent Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 ...
 *
 * Versioning: bump ``Berdaya AgentPluginSDK["sdkVersion"]`` (and the
...
export interface Berdaya AgentPluginSDK {
...
declare global {
  interface Window {
    __HERMES_PLUGIN_SDK__?: Berdaya AgentPluginSDK;
