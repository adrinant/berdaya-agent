...
export const it: Translations = {
  ...
  status: {
    ...
    stopped: "Arrestato",
    updateBerdaya Agent: "Aggiorna Berdaya Agent",
    updatingBerdaya Agent: "Aggiornamento di Berdaya Agent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Scopri, installa, abilita e aggiorna i plugin Berdaya Agent (parità con `hermes plugins`).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Badge Berdaya Agent da collezione, ottenuti dalla cronologia reale delle sessioni. Gli achievement noti non completati vengono mostrati come Scoperti; gli achievement segreti restano nascosti finché non compare il primo comportamento corrispondente.",
      scan_subtitle:
        "Scansione della cronologia delle sessioni Berdaya Agent in corso. La prima scansione può richiedere 5–10 secondi su cronologie ampie.",
    },
    actions: {
      rescan: "Riscansiona",
    },
    stats: {
      ...
      latest: "Più recente",
      latest_hint_empty: "usa Berdaya Agent di più",
    ...
    guide: {
      ...
      secret_body:
        "I segreti nascondono il loro trigger esatto. Quando Berdaya Agent rileva un segnale correlato, la carta passa a Scoperto e mostra il requisito.",
      scan_status_header: "Stato della scansione",
      scan_status_body:
        "Berdaya Agent sta scansionando la cronologia locale una sola volta, poi le carte appariranno automaticamente. Non è bloccato nulla se richiede qualche secondo.",
