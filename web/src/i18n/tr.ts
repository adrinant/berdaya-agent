...
export const tr: Translations = {
  ...
  status: {
    ...
    stopped: "Durduruldu",
    updateBerdaya Agent: "Berdaya Agent'i Güncelle",
    updatingBerdaya Agent: "Berdaya Agent güncelleniyor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Berdaya Agent eklentilerini keşfedin, yükleyin, etkinleştirin ve güncelleyin (`hermes plugins` ile eşdeğer).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gerçek oturum geçmişinden kazanılan, koleksiyonluk Berdaya Agent rozetleri. Bilinen ama henüz tamamlanmamış başarılar Keşfedildi olarak gösterilir; Gizli başarılar ilk eşleşen davranış görünene kadar saklı kalır.",
      scan_subtitle:
        "Berdaya Agent oturum geçmişi taranıyor. Büyük geçmişlerde ilk tarama 5–10 saniye sürebilir.",
    },
    actions: {
      rescan: "Yeniden tara",
    },
    stats: {
      ...
      latest: "En son",
      latest_hint_empty: "Berdaya Agent'i daha çok çalıştır",
      none_yet: "Henüz yok",
    },
    state: {
      unlocked: "Açıldı",
    ...
    guide: {
      ...
      secret_body:
        "Sırlar, tetikleyicilerini saklı tutar. Berdaya Agent ilgili bir sinyal gördüğünde kart Keşfedildi durumuna geçer ve gereksinimini gösterir.",
      scan_status_header: "Tarama durumu",
      scan_status_body:
        "Berdaya Agent yerel geçmişi bir kez tarıyor; sonra kartlar otomatik olarak görünür. Birkaç saniye sürmesi normaldir, hiçbir şey takılmadı.",
