...
export const de: Translations = {
  ...
  status: {
    ...
    stopped: "Gestoppt",
    updateBerdaya Agent: "Berdaya Agent aktualisieren",
    updatingBerdaya Agent: "Berdaya Agent wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    headline:
      "Berdaya-Agent-Plugins entdecken, installieren, aktivieren und aktualisieren (entspricht `hermes plugins`).",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Sammelbare Berdaya-Agent-Abzeichen, verdient durch echten Sitzungsverlauf. Bekannte, noch nicht abgeschlossene Achievements werden als Entdeckt angezeigt; geheime Achievements bleiben verborgen, bis das erste passende Verhalten auftritt.",
      scan_subtitle:
        "Berdaya-Agent-Sitzungsverlauf wird gescannt. Der erste Scan kann bei umfangreichem Verlauf 5–10 Sekunden dauern.",
    },
    actions: {
      rescan: "Neu scannen",
    },
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Berdaya Agent mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Berdaya Agent ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Berdaya Agent scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
