...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateBerdaya Agent: "Mettre à jour Berdaya Agent",
    updatingBerdaya Agent: "Mise à jour de Berdaya Agent…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Berdaya Agent (parité avec `hermes plugins`).",
  ...
  achievements: {
    hero: {
      ...
      title: "Berdaya Agent Achievements",
      subtitle:
        "Badges Berdaya Agent à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Berdaya Agent en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Berdaya Agent davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Berdaya Agent détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Berdaya Agent analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Berdaya Agent ☤",
    },
  },
  kanban: {
