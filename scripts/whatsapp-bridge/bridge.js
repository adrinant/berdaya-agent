...
const DEFAULT_REPLY_PREFIX = '⚕ *Berdaya Agent*\n────────────\n';
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['Berdaya Agent', 'Chrome', '120.0'],
  ...
  sock.ev.on('messages.upsert', async ({ messages, type }) => {
    ...
    for (const msg of messages) {
      ...
      // Ignore Berdaya Agent' own reply messages in self-chat mode to avoid loops.
