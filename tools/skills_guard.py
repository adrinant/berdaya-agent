...
Trust levels:
  - builtin:   Ships with Berdaya Agent. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.hermes/\.env|\~/\.hermes/\.env',
     ...
     "directly references Berdaya Agent secrets file"),
    ...
    (r'\.hermes/config\.yaml|\.hermes/SOUL\.md',
     ...
     "references Berdaya Agent configuration files directly"),
...
# scan. `.skillignore` is the Berdaya Agent-native name; `.clawhubignore` is honored
