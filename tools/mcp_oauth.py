...
This module provides the glue:
    - ``Berdaya AgentTokenStorage``: persists tokens/client-info to disk so they
...
# ---------------------------------------------------------------------------
# Berdaya AgentTokenStorage -- persistent token/client-info on disk
# ---------------------------------------------------------------------------


class Berdaya AgentTokenStorage:
...
def _maybe_preregister_client(
    storage: "Berdaya AgentTokenStorage",
    cfg: dict,
