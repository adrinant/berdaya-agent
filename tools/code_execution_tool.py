...
Lets the LLM write a Python script that calls Berdaya Agent tools via RPC,
...
# available on every platform Berdaya Agent itself runs on.
...
_TOOL_STUBS = {
    ...
    "write_file": (
        ...
        '"""Write content to a file (always overwrites). Returns dict with status. cross_profile=True opts out of the cross-Berdaya Agent-profile soft guard."""',
    ...
    "patch": (
        ...
        '"""Targeted find-and-replace (mode="replace") or V4A multi-file patches (mode="patch"). Returns dict with status. cross_profile=True opts out of the cross-Berdaya Agent-profile soft guard."""',
...
"""Auto-generated Berdaya Agent tools RPC stubs."""
...
"""Auto-generated Berdaya Agent tools RPC stubs (file-based transport)."""
...
def execute_code(
    ...
    to a subset of Berdaya Agent tools.
    ...
    try:
        ...
        # HERMES_TIMEZONE is an internal Berdaya Agent setting and must not leak
...
def build_execute_code_schema(enabled_sandbox_tools: set = None,
    ...
    description = (
        "Run a Python script that can call Berdaya Agent tools programmatically. "
