"""
Timezone-aware clock for Berdaya Agent.
...
Invalid timezone values log a warning and fall back safely — Berdaya Agent never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — Berdaya Agent requires 3.9+)
